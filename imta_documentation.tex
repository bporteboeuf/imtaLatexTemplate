...
%
%The \imtaInlinecode{latex}{anyfontsize} package allows to set the font size to any value, even if they are not natively supported by the font itself. It is used to match the IMT Atlantique's logo more accurately when drawing it using \imtaInlinecode{latex}{tikz}.
%
%\begin{imtaCode}{latex}
